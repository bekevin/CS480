public class Test {
	...
	public String PEMDAS(String input){
		...
		System.out.println(input);//remove not necessary for program
	...
	//This method makes sure that the input is acceptable
	public boolean verifaction(String input){
